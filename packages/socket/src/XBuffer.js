...
class XBuffer{
  static string2buffer(string){
    return iconv.encode(string, 'GB18030');
  }
    position;
    buffer;
    length;
    ...
    writeLong2(low,high){
        this.buffer.fill(low & 0xff,this.position,this.position+1);
        ++this.position;
        this.buffer.fill((low >> 8) & 0xff,this.position,this.position+1);
        ++this.position;
        this.buffer.fill((low >> 16) & 0xff,this.position,this.position+1);
        ++this.position;
        this.buffer.fill((low >> 24) & 0xff,this.position,this.position+1);
        ++this.position;
        this.buffer.fill(high & 0xff,this.position,this.position+1);
        ++this.position;
        this.buffer.fill((high >> 8) & 0xff,this.position,this.position+1);
